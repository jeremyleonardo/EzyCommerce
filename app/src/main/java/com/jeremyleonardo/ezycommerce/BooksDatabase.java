...
public class BooksDatabase {
    ...
    public long insertBookToCart(Book book, int qty) {
        ...
        cv.put(DatabaseHelper.FIELD_BOOK_PRICE, book.getPrice());
    ...
    public ArrayList<Book> getAllBookInCart() {
        ...
        if (cursor.moveToFirst()) {
            while (!cursor.isAfterLast()) {
                ...
                Float price = cursor.getFloat(cursor.getColumnIndex(DatabaseHelper.FIELD_BOOK_PRICE));
